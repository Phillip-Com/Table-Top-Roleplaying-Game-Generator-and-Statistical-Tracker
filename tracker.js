        ...
        function renderStatsSummary() {
          ...
          gameData.characters.forEach(name => {
            ...
            const summaryText = [
              ...
              `Initiative: ${
              s.initiativeRolls.length > 0
              ? formatD20RollsDisplay(s.initiativeRolls)
              : "No rolls yet."
              }`,
              `Total D20 Rolls: ${
              s.totalD20Rolls.length > 0 ? formatRolls(s.totalD20Rolls) : "No rolls yet."
              }`,
              `Total Modded D20 Rolls: ${
              s.totalModD20Rolls.length > 0
