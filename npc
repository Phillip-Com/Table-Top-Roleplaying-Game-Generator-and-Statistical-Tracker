// Section 1: Global Data Arrays
        ...
        const regionRaceData = {
          Random: racesRandom, 
          Empire: racesEmpire,
          SummerIsle: racesSummerIsle,
          Neshiustein: racesNeshiustein,
          CarponIsles: racesCarponIsles,
          Sherus: racesSherus,
          Drustein: racesDrustein,
          Whiteberg: racesWhiteberg,
          Sundermark: racesSundermark,
        }
        // ---------------------------
        ...
        function names(type) {
          ...
          // Arrays (abbreviated here for example, copy all elements)
          const imperialFirstName = ["Sam","Kris","River","Caden","Tanner","Billie","Harper","Taylor","Jo","Ray","Erin","Gale","Bailey","Lee","Jackie","Robin","Kerry","Vic","Chris","Denny","Sidney","Val","Skylar","Gail","Angel","Rory","Harley","Skye","Franky","Skyler","Brook","Logan","Jordan","Will","Avery","Lesley","Quinn","Addison","Sammy","Lane","Tyler","Marley","Noel","Jordan","Reed","Billie","Shay","Jamie","Danny","Elliot","Ashley","Alexis","Aaren","Leslie","Casey","Brett","Charlie","Brice","Clem","Ash","Gabe","Jamie","Reggie","Ali","Aubrey","Lynn","Val","Jess","Steff","Rene","Gene","Bret","Jessie","Gabby","Bev","Emerson","Aiden","Jaime","Silver","Jaden","Ryan","Cory","Fran","Cameron","Alex","Blake","Rudy","Bennie","Blair","Eli","Raylee","Billy","Leigh","Phoenix","Willy","Dane","Terry","Nicky","Drew","Carmen"];
          const imperialLastName = ["Mcdonald","Doyle","Poole","Fraser","Taylor","Mckenzie","Hill","Carson","Mcclain","Stanton","Thompson","Andrews","Shaw","Burton","Fisher","Sharpe","Maxwell","Gonzalez","Olson","Adams","Pearce","Hopkins","White","Robinson","Anderson","Herring","Wiggins","Chang","Rosario","Ware","Fox","Riley","Matthews","Jackson","Holmes","Johns","Nelson","Beck","Strong","Conway","Smith","Wilkinson","King","Stewart","Gallagher","Blackburn","Richards","Dotson","Richmond","Terrell","Byrne","Sutton","Patel","Khan","Bradley","Reid","Dennis","Cochran","Emerson","Lowe","Hamilton","Lawson","Dawson","Howard","Nash","Barnes","Owens","Marks","Mcintosh","Williamson","Wells","May","Simon","England","Pope","Ochoa","Scott","Pearson","Davies","Cooper","Hyde","Morin","Nguyen","Osborn","Sellers","Murray","Cox","Phillips","Parker","Valentine","Fry","Shannon","Tanner","Spears","Black","Kennedy","Baker","Rios","Dixon","Cole"];
          const sherusFirstName = ["Filverel","Larrel","Tyrael","Orym","Dain","Bellas","Ciliren","Amra","Myrdin","Ayre","Malon","Wirenth","Irhaal","Aneirin","Bialaer","Khiiral","Elred","Arel","Jhaan","Elion","Gaerradh","Cornaith","Cyran","Riluaneth","Khyrmin","Goren","Kharis","Adresin","Ehrendil","Tannatar","Gaelin","Vulwin","Pelleas","Selanar","Chaenath","Syvis","Paeris","Gweyir","Lyari","Hycis","Cithrel","Folen","Iefyr","Eldrin","Ryo","Eldaerenth","Lhoris","Ariawyn","Artin","Adorellan","Haldir","Saelethil","Lethonel","Keryth","Shandalar","Lathlaeril","Lysanthir","Ciradyl","Vaeril","Kymil","Arthion","Ailre","Fylson","Sinaht","Lierin","Merellien","Mnementh","Ellisar","Arbane","Taranth","Sanev","Ilbryen","Tarathiel","Elluin","Micaiah","Lazziar","Taenaran","Anhaern","Narbeth","Myrrh","Axilya","Ayen","Elyon","Alaion","Taeral","Elauthin","Ivasaar","Nesterin","Aenwyn","Rolim","Chaenath","Darunia","Nueleth","Ruehnar","Elas","Haemir","Saelihn","Myriil","Elisen","Halueve"];
          const sherusLastName = ["Dorkrana","Enwraek","Joynore","Kelyra","Roxina","Herberos","Herhice","Cardove","Grewarin","Iliyra","Bryroris","Yesfir","Fenlee","Torjor","Araharice","Trisro","Neridi","Gilwynn","Eryra","Uriberos","Erzorwyn","Xyrgeiros","Liaphine","Kearen","Miratumal","Admys","Beimaer","Syldan","Heirie","Valkian","Fargolor","Fadan","Morjeon","Liadan","Qivalur","Bryphyra","Farqen","Carpeiros","Norquinal","Wrancaryn","Keyceran","Eilmenor","Keazumin","Uriro","Ralolee","Omaxidor","Aravalur","Perwraek","Qiqen","Iarthana","Paqen","Omakrana","Elrel","Bipetor","Grekrana","Omazana","Ulagolor","Farceran","Brynan","Elmys","Pressatra","Miawenys","Jolynn","Keyjyre","Kelhice","Cailen","Erralei","Cailamin","Adnala","Iliro","Miranala","Keydan","Yelcaryn","Eilqen","Thethana","Elaydark","Urijeon","Wysarie","Saryra","Presdithas","Gensys","Dorran","Loratumal","Zumbalar","Eilgeiros","Leonelis","Miadi","Mirarieth","Adlee","Cairieth","Holaxalim","Omanelis","Krisbanise","Urijeon","Naetoris","Faren","Ravakrana","Dahice","Rorora","Herkian"];
          const drusteinFirstName = ["Fneeval","Snubbna","Scollbass","Gnappul","Slebblit","Alnasen","Mukpuvon","Ysibbrirt","Clanopwoss","Blidake","Slimzys","Fnarbun","Nabbleck","Kliddlir","Pinsbal","Tadwobe","Aimdiral","Ihebki","Flawakpast","Tewippast","Ruklall","Glaapwass","Flure","Knimwem","Jaalneck","FLeerbeesi","Fnekmeru","Loculbec","Ufenja","Gnahanjull","Thooppil","Slimtis","Gadwyn","Phagbart","Slemdam","Adlohin","Odwodieck","Clomiddlat","Iseedba","Sledilnirt","Fenjaa","Fnollmeeg","Lepnep","Ponjor","Gnegbiel","Gnellbyrug","Scymwohe","Gnaacuddnec","Gnenirker","Dewaabblo","Clelwo","Phepnick","Lanba","Cymbai","Scinsnil","Blolnonie","Timjere","Slamumpit","Gidoblyrt","Niedallba","Sceves","Smurkist","Zaglir","Glankar","Folkess","Tenjewy","Bladdwumic","Unibbnoock","Ifellne","Flivuknil","Clilkeeg","Shaidlaar","Hakpim","Bimwin","Snaprim","Shagbagust","Gnillbacam","Dimembo","Ylybust","Snievainglon","Binklet","Flankkug","Flimpie","Nepnyr","Fibblill","Phansbiso","Aiklyciell","Nivoonki","Glusirkut","Wefikpool","Snabniss","Honbick","Hebblai","Gleenjit","Dodlel","Sceensmarep","Lympegom","Josieblert","Zaanokmop","Levoppa"];
          const drusteinLastName = ["Fneeval","Snubbna","Scollbass","Gnappul","Slebblit","Alnasen","Mukpuvon","Ysibbrirt","Clanopwoss","Blidake","Slimzys","Fnarbun","Nabbleck","Kliddlir","Pinsbal","Tadwobe","Aimdiral","Ihebki","Flawakpast","Tewippast","Ruklall","Glaapwass","Flure","Knimwem","Jaalneck","FLeerbeesi","Fnekmeru","Loculbec","Ufenja","Gnahanjull","Thooppil","Slimtis","Gadwyn","Phagbart","Slemdam","Adlohin","Odwodieck","Clomiddlat","Iseedba","Sledilnirt","Fenjaa","Fnollmeeg","Lepnep","Ponjor","Gnegbiel","Gnellbyrug","Scymwohe","Gnaacuddnec","Gnenirker","Dewaabblo","Clelwo","Phepnick","Lanba","Cymbai","Scinsnil","Blolnonie","Timjere","Slamumpit","Gidoblyrt","Niedallba","Sceves","Smurkist","Zaglir","Glankar","Folkess","Tenjewy","Bladdwumic","Unibbnoock","Ifellne","Flivuknil","Clilkeeg","Shaidlaar","Hakpim","Bimwin","Snaprim","Shagbagust","Gnillbacam","Dimembo","Ylybust","Snievainglon","Binklet","Flankkug","Flimpie","Nepnyr","Fibblill","Phansbiso","Aiklyciell","Nivoonki","Glusirkut","Wefikpool","Snabniss","Honbick","Hebblai","Gleenjit","Dodlel","Sceensmarep","Lympegom","Josieblert","Zaanokmop","Levoppa"];
          const whitebergFirstName = ["Nurastarlug","Dalomnumi","Elkdraec","Uddaec","Douddorlug","Duridon","Maddeath","Glatgreg","Juzzad","Makdrul","Hurbouhilda","Skosdraegret","Fobuwynn","Torekwuigit","Thostobelyn","Norhilynn","Tukkaserd","Thadgroure","Noraldrealine","Dadena","Longroul","Durirdumli","Hasdrath","Lobrug","Hourbatum","Lodmulim","Duframri","Doukkeack","Thamnonlir","Deznomri","Norarhas","Borrami","Jastrunli","Algunri","Longrorlum","Tusdrul","Whundran","Forroick","Nukrorlun","Grasdreas","Umifraeg","Dutdraeg","Gaddol","Snasgrer","Dhulmaem","Strodmug","Hethot","Baritean","Skardar","Tusgrorlig","Yufraehilde","Foznumora","Darsaebella","Kasdraere","Fozzousli","Bodgrabyrn","Nathahilda","Lobrugrett","Budwaesli","Yognerika","Barithaic","Darestotir","Hourmoun","Thorheck","Madeck","Yufuli","Doutaed","Hedonlir","Jorsout","Fokhurum","Thragheagit","Thranmagith","Doumnulda","Kingrealin","Nuteaginn","Bakwolin","Badgribena","Groostraedeth","Ughaelyn","Aragnotain","Doznid","Fonoick","Heddorlum","Jozed","Nothotum","Gingrorlig","Alfofod","Voldrotir","Khousuil","Doumaen","Hetmanelynn","Hadulyn","Wemdeataine","Jagrotrude","Smamdrabella","Homretelyn","Harhaebelyn","Grasdraebelynn","Kukkingrid","Stroldraegith"];
          const whitebergLastName = ["Cragstone","Alebasher","Battlebrand","Merryspine","Hillbelt","Ashbuster","Hammerhorn","Cragmaster","Lightbrew","Dragonforged","Dimfeet","Bloodgut","Graniteheart","Bonemaker","Marblebranch","Shadowtank","Brewshoulder","Grayforge","Kragshaper","Shadowfoot","Bitterfeet","Stormbasher","Hillarm","Bitterbrewer","Boulderpike","Ingottank","Ironfall","Icecoat","Stormshoulder","Dragonhide","Frosthood","Lavahide","Boulderstone","Goldenbane","Silvermantle","Blazingbender","Snowbelly","Windfeet","Ingotcoat","Thundermace","Barbedspine","Trollflayer","Barrelrock","Drakemantle","Nighttank","Trollbreaker","Runegrip","Onyxhelm","Bricktoe","Dragongbringer","Deepbrow","Alebrow","Kegbraids","Redthane","Graymail","whitforged","Ashhand","Runemane","Flintbow","Opalgranite","Coinpike","Alefury","Ashtoe","Snowshaper","Rubyfury","Grumblegut","Shatterhelm","Battlefury","Fierybeard","Warhood","Thundertoe","Deephood","Blessedcoat","Nightbane","Minegrip","Coalbrow","Kegdigger","Boulderchest","Kragfoot","Bitterbringer","Longhead","Wraithview","Leadhood","Wyvernbrand","Blessedriver","Icecloak","Barbedmantle","Coinborn","Icehorn","Orcchest","Brightborn","Orcbraid","Metalbelly","Mithrilchin","Heavyspine","Anvilmace","Bottlemaster","Honormace","Kragmaul","Bitterbraid"];
          const sundermarkFirstName = ["Ange","Jean-Pierre","Roger","Laurent","Aubin","Alexandre","Jean-Philippe","Yves","Cyril","Raoul","Claudette","Ines","Nina","Melodie","Nathalie","Astrid","Lucile","Celine","Muriel","Jennifer","Jean-Loup","Rene","Francois","Gabriel","Tristan","Abraham","Gilbert","Philibert","Enzo","Lucien","Agnes","Brigitte","Marinette","Leonie","Colette","Lesly","Julie","Jeannette","Gisele","Marlene","William","Maxence","Remy","Leonard","Francis","Augustin","Thomas","Charles","Gregoire","Miryam","Violaine","Emilienne","Adrienne","Lorie","Silviane","Elodie","Amelie","Clarisse","Karine","Gaston","Simon","Evrard","Alex","Eloi","Benjamin","Josselin","Emile","Julien","Patrice","Lea","Vistoire","Josseline","Marie-France","Rose-Marie","Chloe","Pascaline","Radegonde","Gabriella","Roberte","Gwenaël","Yvon","Hugues","Fabien","Isaac","Mathieu","Simon","Djeferson","Rodolphe","Ignace","Margot","Therese","Simonne","Georgette","Marie-Francoise","Emeline","Laura","Philomene","Michele","Victoria","Egide"];
          const sundermarkLastName = ["Lecerf","Dior","Poullain","Lagarde","Allemand","Courtial","Barbeau","Bassot","De Villiers","Chagnon","Lucy","Carrel","Gouin","Beaulieu","Ange","Sadoul","Sole","Michaux","Lalande","Arceneaux","Manaudou","Affre","Gachet","Messier","Masson","Bacque","Leroux","Blanchard","Guillaume","Astier","Rousseau","Tremaux","Loup","Flandin","Boudraux","Toutain","Bachelet","Niel","Pretre","Loupe","Tourneur","Donnet","Brasseur","Barbier","Popelin","Carre","Lebas","Pomeroy","Gigot","Serre","Bonnel","Chopin","Rousselle","Marchal","Leger","Granet","De Verley","Vidal","Pelissier","Boulet","Cartier","Laframboise","Jacquet","Gerard","Cordonnier","Chausson","Bittencourt","Genest","Desmarais","Jauffret","Haillet","Cellier","Dufresne","Martin","Bertillion","Brochard","Menetries","Besnard","Hauet","Kleber","Bourbon","Wathelet","Sylvestre","Asselin","Maret","Vasseur","Demaret","Portier","Gilson","Beaugendre","Lemery","Batteux","Pasquier","Escoffier","Bachelot","Fouche","Gauthier","Benett","Cochet","Larousse"];

          // Main switch
          switch(type) {
            case "Empire": case "SummerIsle": case "CarponIsles": case "Neshiustein": // Imperial regions
              firstName = imperialFirstName[randomNumber1];
              lastName = imperialLastName[randomNumber2];
              break;
            case "Sherus": // Sherus
              firstName = sherusFirstName[randomNumber1];
              lastName = sherusLastName[randomNumber2];
              break;
            case "Drustein": // Drustein
              firstName = drusteinFirstName[randomNumber1];
              lastName = drusteinLastName[randomNumber2];
              break;
            case "Whiteberg": // Whiteberg
              firstName = whitebergFirstName[randomNumber1];
              lastName = whitebergLastName[randomNumber2];
              break;
            case "Sundermark": // Sundermark
              firstName = sundermarkFirstName[randomNumber1];
              lastName = sundermarkLastName[randomNumber2];
              break;
            default:
        ...
        // Personality 1 generator
        function personalityTraits1(background) {
          const randomNumber = Math.floor(Math.random() * 8);

          const back = background.toLowerCase().replace(/\s/g, '');
          ...
          const personalityTraits = {
            ...
            artisan: [
              "I take immense pride in my work and notice craftsmanship everywhere I go.",
            ...
            farmer: [
              "I notice weather, soil, and seasons more than most people.",
            ...
            guard: [
              "I am always alert to exits, threats, and unusual behavior in a room.",
            ...
            guide: [
              "I pay close attention to landmarks, paths, and subtle environmental changes.",
            ...
            merchant: [
              "I am always calculating the value of things, even when I try not to.",
            ...
            scribe: [
              "I notice inconsistencies, errors, and missing details immediately.",
            ...
            wayfarer: [
              "I am comfortable sleeping almost anywhere.",
          ...
          return personalityTraits[back][randomNumber];
        }

        // Personality 2 generator
        function personalityTraits2(background) {
          const randomNumber = Math.floor(Math.random() * 8);
          const back = background.toLowerCase().replace(/\s/g, '');
        ...
        // Ideals generator
        function ideals(background, alignment) {
          const randomNumber1 = Math.floor(Math.random() * 1000); // Large enough to use modulo
          ...
          const idealLawful = {
            ...
            artisan: [
              "Perfection. True craftsmanship only exists when methods are refined and preserved across generations. (Lawful)",
            ...
            farmer: [
              "Tradition. The rhythms of planting and harvest are older than any kingdom. (Lawful)",
              "Stability. Order in nature and society keeps life predictable and safe. (Lawful)",
            ],
            guard: [
              "Order. Without rules, society collapses into chaos and suffering. (Lawful)",
              "Duty. I exist to uphold structure, not question it. (Lawful)",
            ],
            guide: [
              "Reliability. A guide must never break trust or abandon responsibility. (Lawful)",
            ...
            merchant: [
              "Contracts. A deal is sacred and must be honored once struck. (Lawful)",
            ...
            scribe: [
              "Truth. Knowledge must be recorded accurately and preserved without distortion. (Lawful)",
            ...
            wayfarer: [
              "Direction. Even wanderers need paths and boundaries to stay safe. (Lawful)",
          ...
          const idealChaotic = {
            ...
            artisan: [
              "Innovation. Every object can be improved, and tradition should never limit creativity. (Chaotic)",
            ...
            farmer: [
              "Freedom. The land belongs to no lord or law, only those who work it. (Chaotic)",
              "Change. Seasons shift, and so must we—nothing should remain rigid. (Chaotic)",
            ],
            guard: [
              "Judgment. Rules mean nothing without context and conscience. (Chaotic)",
              "Reform. Power must be challenged when it becomes unjust. (Chaotic)",
            ],
            guide: [
              "Freedom. No path should be owned or restricted. (Chaotic)",
            ...
            merchant: [
              "Opportunity. Rules exist to be worked around. (Chaotic)",
            ...
            scribe: [
              "Revelation. Knowledge should be free from restriction or gatekeeping. (Chaotic)",
            ...
            wayfarer: [
              "Freedom. No one should be bound to a single place or purpose. (Chaotic)",
          ...
          const idealNeutral = {
            ...
            artisan: [
              "Mastery. The purpose of life is to refine one's skill to its purest form. (Neutral)",
            ...
            farmer: [
              "Balance. Life is about taking only what the land can give in return. (Neutral)",
              "Endurance. Survival matters more than ideals or ambition. (Neutral)",
            ],
            guard: [
              "Balance. My duty is to protect people, not systems. (Neutral)",
              "Stability. Peace matters more than who enforces it. (Neutral)",
            ],
            guide: [
              "Survival. Getting through the journey matters more than philosophy. (Neutral)",
            ...
            merchant: [
              "Balance. Trade should benefit both sides, or it will fail eventually. (Neutral)",
            ...
            scribe: [
              "Understanding. Knowledge itself is the highest pursuit. (Neutral)",
            ...
            wayfarer: [
              "Endurance. Keep moving forward, no matter what. (Neutral)",
          ...
          const idealGood = {
            ...
            artisan: [
              "Service. My craft exists to improve the lives of others, not myself. (Good)",
            ...
            farmer: [
              "Community. No one should go hungry while others have enough. (Good)",
              "Care. The land, animals, and people are all worth protecting. (Good)",
            ],
            guard: [
              "Protection. I exist to shield the innocent, no matter the cost. (Good)",
              "Mercy. Even criminals deserve fairness and restraint. (Good)",
            ],
            guide: [
              "Protection. No traveler under my care will be left behind. (Good)",
            ...
            merchant: [
              "Fair Trade. No one should be cheated in a deal. (Good)",
            ...
            scribe: [
              "Sharing. Knowledge should help others grow and improve. (Good)",
            ...
            wayfarer: [
              "Compassion. Every stranger on the road deserves kindness. (Good)",
          ...
          const idealEvil = {
            ...
            artisan: [
              "Exploitation. Skill is power, and I intend to profit from those who lack it. (Evil)",
            ...
            farmer: [
              "Possession. The land exists to serve those strong enough to claim it. (Evil)",
              "Survival. Only I and mine matter when resources are scarce. (Evil)",
            ],
            guard: [
              "Control. Fear is the most effective form of order. (Evil)",
              "Power. Authority is only meaningful when it cannot be challenged. (Evil)",
            ],
            guide: [
              "Exploitation. Travelers are resources to be used or abandoned. (Evil)",
            ...
            merchant: [
              "Profit. Everything and everyone has a price. (Evil)",
            ...
            scribe: [
              "Control. Those who hold knowledge hold power over others. (Evil)",
            ...
            wayfarer: [
              "Survival. The road belongs to those willing to take what they need. (Evil)",
          ...
          switch (alignment) {
            case "Lawful Good":
              ideal = randomNumber2 === 0 ? idealLawful[back][randomNumber1 % idealLawful[back].length] : idealGood[back][randomNumber1 % idealGood[back].length];
              break;
            case "Neutral Good":
              ideal = randomNumber2 === 0 ? idealNeutral[back][randomNumber1 % idealNeutral[back].length] : idealGood[back][randomNumber1 % idealGood[back].length];
              break;
            case "Chaotic Good":
              ideal = randomNumber2 === 0 ? idealChaotic[back][randomNumber1 % idealChaotic[back].length] : idealGood[back][randomNumber1 % idealGood[back].length];
              break;
            case "Lawful Neutral":
              ideal = randomNumber2 === 0 ? idealLawful[back][randomNumber1 % idealLawful[back].length] : idealNeutral[back][randomNumber1 % idealNeutral[back].length];
              break;
            case "Neutral":
              ideal = idealNeutral[back][randomNumber1 % idealNeutral[back].length];
              break;
            case "Chaotic Neutral":
              ideal = randomNumber2 === 0 ? idealChaotic[back][randomNumber1 % idealChaotic[back].length] : idealNeutral[back][randomNumber1 % idealNeutral[back].length];
              break;
            case "Lawful Evil":
              ideal = randomNumber2 === 0 ? idealLawful[back][randomNumber1 % idealLawful[back].length] : idealEvil[back][randomNumber1 % idealEvil[back].length];
              break;
            case "Neutral Evil":
              ideal = randomNumber2 === 0 ? idealNeutral[back][randomNumber1 % idealNeutral[back].length] : idealEvil[back][randomNumber1 % idealEvil[back].length];
              break;
            case "Chaotic Evil":
              ideal = randomNumber2 === 0 ? idealChaotic[back][randomNumber1 % idealChaotic[back].length] : idealEvil[back][randomNumber1 % idealEvil[back].length];
              break;
          }
        ...
        // Bonds generator
        function bonds(background) {
          const randomNumber = Math.floor(Math.random() * 6); // 0–77
          const back = background.toLowerCase().replace(/\s/g, '');
          ...
          const bondsArray = {
            ...
            artisan: [
              "My craft was taught to me by someone I owe everything to, and I will not disgrace their teachings.",
            ...
            farmer: [
              "My family’s land is everything to me, and I will protect it at any cost.",
            ...
            guard: [
              "I failed to protect someone I was sworn to defend, and I will never let it happen again.",
            ...
            guide: [
              "I once lost travelers under my care, and I will never let it happen again.",
            ...
            merchant: [
              "I will restore my family’s fortune and reputation, no matter the cost.",
            ...
            scribe: [
              "I am protecting a piece of knowledge that others would destroy if they found it.",
            ...
            wayfarer: [
              "I am searching for someone I lost while traveling long ago.",
          ...
          return bondsArray[back][randomNumber];
        }

        // Flaws generator
        function flaws(background) {
          const randomNumber = Math.floor(Math.random() * 6); // 0–6
          const back = background.toLowerCase().replace(/\s/g, '');
          ...
          const flawsArray = {
            ...
            artisan: [
              "I become so focused on perfecting my craft that I ignore everything else around me.",
            ...
            farmer: [
              "I am stubborn to a fault and resist change even when it is clearly needed.",
            ...
            guard: [
              "I assume authority is always correct, even when evidence suggests otherwise.",
            ...
            guide: [
              "I become reckless when I think I know the safest path.",
            ...
            merchant: [
              "I measure everything in terms of profit, even people and relationships.",
            ...
            scribe: [
              "I become so focused on details that I miss the bigger picture.",
            ...
            wayfarer: [
              "I avoid staying in one place long enough to form lasting ties.",
          ...
          return flawsArray[back][randomNumber];
        }
        ...
        document.getElementById("generate").addEventListener("click", () => {
          ...
          // Determine name
          let name;
          console.log(customNameType.value)
          if (customNameType.value !== "Any") {
            name = names(customNameType.value);
          } else {
            name = names(region);
          }
